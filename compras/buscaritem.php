...
if ($action == 'ajax') {
    ...
    $sFields = "
`articulos`.`idArticulo`,`articulos`.`descripcion`,round(`articulos`.`preciocompra`,0) as
preciocompra,round(`articulos`.`precioventa`,0) as precioventa";
            ...
            <table class="table">
                ...
                ?>
                    <tr>
                        ...
                        <input type="hidden" id="concepto_<?php echo $idConcepto; ?>" value="
