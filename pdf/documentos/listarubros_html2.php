<page backtop="10mm" backbottom="10mm" backleft="20mm" backright="20mm">
    ...
    <page_footer>
        <table style="width: 100%; border: solid 1px black;">
            <tr>
                ...
                <td style="text-align: right; width: 50%">página [[page_cu]]/[[page_nb]]
                </td>
            </tr>
        </table>
    </page_footer>
    ...
    <table style="width: 80%;border: solid 1px #5544DD; border-collapse: collapse" align="center">
        <thead>
            <tr>
                <th style="width: 30%; text-align: left; border: solid 1px #900C3F; background: #900C3F; text-color: #FFFFFF;"><span style="color: #FFFFFF;">CODIGO</span></th>
                <th style="width: 30%; text-align: left; border: solid 1px #900C3F; background: #900C3F; text-color: #FFFFFF;"><span style="color: #FFFFFF;">NOMBRE</span></th>
            </tr>
        </thead>
        <tbody>
            <?php
